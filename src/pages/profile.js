            ...
            <div className="justify-content-start ml-5 mr-5 mt-5 ">
                ...
                <div className="d-md-flex">
                    <div className="justify-content-start" onClick={handleEditProfile}>
                        <img src={Orang} alt=''></img>
                        <button className="btn-block btn-edit-css mt-2 text-white">Edit Profile</button>
                    </div>
                    <div className="justify-content-end ml-3">
                        <div className="mb-3">
                            <h5 className="subtitle-edit">FullName</h5>
                            <span className="isiProfile-edit">Andi</span>
                        </div>
                        <div className="mb-3">
                            <h5 className="subtitle-edit">Email</h5>
                            <span className="isiProfile-edit">andigans@gmail.com</span>
                        </div>
                        <div>
                            <h5 className="subtitle-edit">Phone</h5>
                            <span className="isiProfile-edit">083896833122</span>
                        </div>
                    </div>
                </div>
